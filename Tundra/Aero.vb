...
#End Region
    ...
    Public Sub Surround(ByVal Window As Form, ByVal Control As Control, Optional ByVal AutomaticColor As Boolean = True)
        If DWMEnabled() Then
            Aero.Extend(Window, Control.Left, Window.ClientSize.Width - Control.Right, Control.Top, Window.ClientSize.Height - Control.Bottom, AutomaticColor)
        End If
    End Sub
