...
Public Class StylizedRadioButton
    ...
    Private Sub ReadStyle()
        ...
        CheckedColors = ReadColorList(GetValue(Style, "Checked Colors"))
        CheckedPositions = ReadSingleList(GetValue(Style, "Checked Positions"))
        CheckedAngle = CInt(GetValue(Style, "Checked Angle"))
        CheckedBorderColor = ReadColor(GetValue(Style, "Checked Border Color"))
        CheckedTextColor = ReadColor(GetValue(Style, "Checked Text Color"))
        CheckedHighlightColor = ReadColor(GetValue(Style, "Checked Highlight Color"))
    End Sub
